...
Random Router achieves strong performance (37.7 score on ScienceWorld; 24.2\% on HLE) by mixing model capabilities. In contrast, the commercial OpenRouter baseline performs poorly on ScienceWorld.
