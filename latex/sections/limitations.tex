...
While \textsc{LearnedRouter} reduces LLM inference costs, it introduces additional computation for history encoding (running the embedding model) and Q-value computation. For very short episodes, this overhead may outweigh the routing benefits. However, for episodes with 10+ steps, the routing savings typically dominate.
